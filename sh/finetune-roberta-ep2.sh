#!/bin/bash
#SBATCH --job-name=finetune-roberta-ep2
#SBATCH --nodes=1                   
#SBATCH --ntasks=1                  
...
python -u train.py --pretrained_checkpoint /gpfsnyu/scratch/yw3642/nbme/ckpt/2022-04-25-22:37:05-bfb7/checkpoint-21074 \
